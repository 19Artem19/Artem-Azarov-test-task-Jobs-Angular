...
class JobBoardComponent {
  ...
  static {
    this.ɵcmp = /*@__PURE__*/_angular_core__WEBPACK_IMPORTED_MODULE_3__["ɵɵdefineComponent"]({
      ...
      decls: 6,
      vars: 10,
      consts: [[1, "wrapper-container"], [1, "job-wrapper"], ["class", "job", 3, "routerLink", 4, "ngFor", "ngForOf"], [1, "pagination-container"], [1, "pagination-wrapper", 3, "page", "pageSize", "rotate", "collectionSize", "maxSize", "pageChange"], [1, "job", 3, "routerLink"], [1, "job__image-container"], [1, "job__image", 3, "src"], [1, "job__content"], [1, "job__description"], [1, "job__title"], [1, "job__department"], [1, "job__location"], ["src", "/assets/icons/location-marker.svg", 1, "job__location-marker", 3, "svgStyle"], [1, "job__location-address"], [1, "job__info"], [1, "job__rating"], ["class", "job__rating-marker", "src", "/assets/icons/rating.svg", 3, "svgStyle", 4, "ngFor", "ngForOf"], [1, "job__select"], [1, "job__save", 3, "click"], ["src", "/assets/icons/save.svg", 3, "svgStyle"], [1, "job__post"], ["src", "/assets/icons/rating.svg", 1, "job__rating-marker", 3, "svgStyle"]],
